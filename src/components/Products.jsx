          ...
          <div class="container px-5 py-24 mx-auto">
            ...
            <div class="lg:w-1/4 md:w-1/2 p-4 w-full container1">
                ...
                <div class="mt-4">
                  ...
                  <p class="mt-1">Net Weight 16OZ (454 Gram) 78-82 <br /> <b>$21.15</b> </p>
                  <button
                    type="button"
              ...
              <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                <a class="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
                    class="object-cover object-center w-full h-full block"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR75toFbi_lzlj-yskduknjoTsfFJiVW1cOhkCNSvsaMsHElYP9SJRPcFIvee6hiTvmWeE&usqp=CAU"
                  ></img>
                </a>
                <div class="mt-4">
                  <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">
              ...
              <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                <a class="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
                    class="object-cover object-center w-full h-full block"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpJyBde6frLmkmGy86K8MhnCL6SOkctPGaXg&usqp=CAU"
                  ></img>
                </a>
                <div class="mt-4">
                  <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">
              ...
              <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                <a class="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
                    class="object-cover object-center w-full h-full block"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_ixFpbqaXyYdzjQA-bsEqEn6W_46jSwTvkA&usqp=CAU"
                  ></img>
                </a>
                <div class="mt-4">
                  <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">
